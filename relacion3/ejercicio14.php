...
<head>
    ...
    <title>14. Funciones anonimas</title>
    <link
...
<body>
    <div class="d-flex flex-column justify-content-center align-items-center vh-100">
        ...
        <?php 
        /**
         * --- DEMOSTRACIÓN DE FUNCIONES ANÓNIMAS (CLOSURES) ---
         * Una función anónima es una función sin un nombre definido.
         * Se asignan a variables y se pueden invocar usando el nombre de esa variable.
         * Son útiles para encapsular pequeñas operaciones o para usarlas como callbacks.
         */
        if(isset($_GET['num'])){
            // Recoge el número del formulario y lo convierte a entero.
            $n = intval($_GET['num']);

            // Define la fórmula de la circunferencia como una función anónima.
            ...
            // Muestra los resultados con un formato más claro usando Bootstrap y redondeando a 2 decimales.
