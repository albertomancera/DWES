<?php
// Índice automático para la carpeta cursoPHP
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="/DWES/super-index.php">DWES · cursoPHP</a>
    ...
    <main class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h4 m-0">cursoPHP - Índice automático</h1>
    ...
    <footer class="bg-light py-3 mt-5">
        <div class="container text-center small text-muted">© <?php echo date('Y'); ?> DWES · cursoPHP</div>
    </footer>
